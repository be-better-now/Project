...
public class MainController extends HttpServlet {
    ...
    public FlowerDAO flowerDAO = new FlowerDAO();
            ...
            if (action == null) {
                ...
                if (action.equals("login")) {
                    ...
                    try {
                        ...
                        String flowerID = request.getParameter("txtBookID");
                        String flowerName = request.getParameter("txtTitle");
                        ...
                        if(flowerID==null || flowerID.trim().isEmpty()){
                            checkError = true;
                            request.setAttribute("txtFlowerID_error", "Flower ID cannot be empty.");
                        }
