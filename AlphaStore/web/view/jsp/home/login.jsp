                                ...
                                <div class="account_form">
                                    ...
                                    <form id="login-form" action="LoginServlet" method="post">
                                        ...
                                        <div style="margin-top: 20px">
                                            <a class="login-with-google-btn" href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8080/TheAlphaStore/LoginServlet&response_type=code
