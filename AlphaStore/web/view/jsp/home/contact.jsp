                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="contact_message contact_info">
                                    <h3>contact us</h3>    
                                    <p>The Alpha Store is the perfect destination for gentlemen who are passionate about sports and style. With a diverse collection ranging from clothing and footwear to sports accessories, we are committed to bringing our customers the highest quality and most fashionable products. Whether it's light workouts or intense training sessions, The Alpha Store always has the right options for you to shine and stay comfortable.</p>
                                    <p>Explore now to experience class and style at The Alpha Store!</p>
                                    <ul>
                                        <li><i class="fa fa-fax"></i>  Address : E2a-7 Lot, D1 Street, High-Tech Park, Long Thanh My Ward, Thu Duc City, Ho Chi Minh City.</li>
                                        <li><i class="fa fa-envelope-o"></i> <a href="#">alphastore@gmail.com</a></li>
