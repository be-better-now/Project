                                        ...
                                        <div class="single_slider" style="background-image: url(view/assets/home/img/slider/slide_1.png)">
                                            <div class="slider_content">
                                                <div class="slider_content_inner">  
                                                    <h1>Men's Fashion</h1>
                                                    <p>Elevate Your Style, Define Your Legacy! </p>
                                        ...
                                        <div class="single_slider" style="background-image: url(view/assets/home/img/slider/slide_2.png)">
                                            <div class="slider_content">
                                                <div class="slider_content_inner">  
                                                    ...
                                                    <p>Fresh Looks, Bold Statements! </p>
                                                    <a href="ShopServlet">shop now</a>
                                                </div>         
                                            </div>         
                                        </div>
                                        <div class="single_slider" style="background-image: url(view/assets/home/img/slider/slide_3.png)">
                                            <div class="slider_content">  
                                                <div class="slider_content_inner">  
                                                    ...
                                                    <p>Timeless Style, Ultimate Perfection! </p>
                                                    <a href="ShopServlet">shop now</a>
                                                </div> 
                                            </div> 
                                        </div>
                                                        ...
                                                        <div class="single_product">
                                                            <div class="product_thumb">
                                                                ...
                                                                <div class="product_action">
                                                                    <!--<a href="CartServlet?action=Add&product_id=${p.id}&quantity=1"> <i class="fa fa-shopping-cart"></i> ADD TO CART</a>-->
                                                                    <button style="display: block;
                                                                            ...
                                                                            font-size: 13px;" onclick="addProductToCart('Add',${p.id}, 1)"><i class="fa fa-shopping-cart"></i> ADD TO CART</button>
                                                            ...
                                                            <div class="product_info">
                                                                <ul>
                                                                    <!--<li><a href="WishlistServlet?action=Add&product_id=${p.id}" title=" Add to Wishlist ">Wish List</a></li>-->
                                                                    <li><button style="color: red;
                                                                                border: none;
                                                                                border-radius: 4px;
                                                                                font-size: 13px;
                                                                                padding: 2px 11px;
                                                                                font-weight: 600;" onclick="addProductToWishlist('Add',${p.id})">Wish List</button></li>
                                                                    <li><a href="SingleProductServlet?product_id=${p.id}" title="View Detail">View Product</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
