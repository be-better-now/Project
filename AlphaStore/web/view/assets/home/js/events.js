...
function searchProducts(tag, scope) {
    ...
    var scope = scope;
    $.ajax({
        url: "/TheAlphaStore/SearchServlet",
        type: "get",
        data: {
            txtSearch: text,
            scope: scope
...
function addProductToWishlist(action, product_id) {
    ...
    var productId = product_id;
    $.ajax({
        url: "/TheAlphaStore/WishlistServlet",
        type: "get",
        data: {
            action: action,
            product_id: productId,
...
function checkDuplicate(input) {
    ...
    $.ajax({
        url: "/TheAlphaStore/RegisterServlet",
        type: "post",
        data: {
            username: username,
