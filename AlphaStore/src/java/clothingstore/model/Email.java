...
public class Email {
    ...
    public String subjectContact(String name) {
        return "AlphaStore - Chào " + name + " cảm ơn bạn vì đã liên hệ với chúng tôi";
    }
    
    public String subjectNewOrder() {
        return "AlphaStore - Đặt hàng thành công";
    }

    public String subjectSubsribe() {
        return "AlphaStore - bạn có thông báo mới";
    }

    public String subjectForgotPass() {
        return "AlphaStore - mã code xác nhận";
    }
    ...
    public String messageContact(String name) {
        return "<!DOCTYPE html>\n"
                ...
                + "                                       margin:20px 0;\"><span style=\"color:#e67e22;\">AlphaStore</span>Shop</p> \n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                            <tr>\n"
                ...
                + "                                        color:#e67e22;\n"
                + "                                        margin:30px 0;\">CẢM ƠN VÌ BẠN ĐÃ LIÊN HỆ ALPHA STORE</h1>\n"
                ...
                + "                                <td align=\"center\"> \n"
                + "                                    Alpha Store Ho Chi Minh - 0123 456 789 - alphastore@gmail.com\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                        </table>\n"
                + "                    </div> \n"
    ...
    public String messageNewOrder(String name, int sl, double total) {
        return "<!DOCTYPE html>\n"
                ...
                + "                            <tr class=\"contact\" style=\"font-size:11px; color:#999;\">\n"
                + "                                <td align=\"center\"> \n"
                + "                                    AlphaStore Shop Ho Chi Minh - 0123 456 789 - alphastore@gmail.com\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                        </table>\n"
                + "                    </div> \n"
    ...
    public String messageFogot(String name, int code) {
        return "<!DOCTYPE html>\n"
                ...
                + "                            <tr class=\"contact\" style=\"font-size:11px; color:#999;\">\n"
                + "                                <td align=\"center\"> \n"
                + "                                    AlphaStore Ho Chi Minh - 0123 456 789 - alphastore@gmail.com\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                        </table>\n"
                + "                    </div> \n"
    ...
    public String messageSubscribe() {
        return "<!DOCTYPE html>\n"
                ...
                + "                                <td>\n"
                + "                                    <p class=\"brand\" style=\"margin:5px 0 0; font-size:30px;\n"
                + "                                       margin:20px 0;\"><span style=\"color:#e67e22;\">Alpha</span>Store</p> \n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                            <tr>\n"
                + "                                <td class=\"border\" style=\"border-top:2px solid #e67e22;\n"
                ...
                + "                                        color:#e67e22;\n"
                + "                                        text-height:36px;\n"
                + "                                        margin:30px 0;\">CHÀO MỪNG BẠN ĐÃ ĐẾN VỚI ALPHA STORE</h1>\n"
